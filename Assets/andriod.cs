...
public class AndroidStatusBar
{
    ...
    // Constants
    private const uint DEFAULT_BACKGROUND_COLOR = 0xffD0DC88;
	...
	public static int GetStatusBarHeight()
	{
		...
		using (var unityPlayer = new AndroidJavaClass("com.unity3d.player.UnityPlayer"))
		{
			...
			{
				using (var resource = activity.Call<AndroidJavaObject>("getResources"))
				{
					var resourceId = resource.Call<int>("getIdentifier", new object[] { new AndroidJavaObject("java.lang.String", "status_bar_height"), new AndroidJavaObject("java.lang.String", "dimen"), new AndroidJavaObject("java.lang.String", "android") });
					if (resourceId > 0)
					{
						result = resource.Call<int>("getDimensionPixelSize", resourceId);
					}
				}
			}
		}
