...
namespace TMPro
{
    ...
    /// </summary>
    [AddComponentMenu("UI/Mod_InputField")]
    public class Mod_InputField : Selectable,
        ...
        IScrollHandler
    {
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (!isFocused && m_SelectionStillActive)
            {
                ...
                if (selectedObject != null && selectedObject != this.gameObject)
                {
                    ...
                    if (selectedObject.GetComponent<Mod_InputField>() != null)
                        ReleaseSelection();
        ...
        public void ActivateInputField(bool full = true)
        {
