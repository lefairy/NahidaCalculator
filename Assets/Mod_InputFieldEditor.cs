...
namespace TMPro.EditorUtilities
{
    ...
    [CustomEditor(typeof(Mod_InputField), true)]
    public class Mod_InputFieldEditor : SelectableEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_foldout.fontSettings)
            {
                ...
                {
                    Mod_InputField inputField = target as Mod_InputField;
                ...
                if (!m_ContentType.hasMultipleDifferentValues)
                {
                    ...
                    if (m_ContentType.enumValueIndex == (int)Mod_InputField.ContentType.Standard ||
                        m_ContentType.enumValueIndex == (int)Mod_InputField.ContentType.Autocorrected ||
                        m_ContentType.enumValueIndex == (int)Mod_InputField.ContentType.Custom)
                    {
                        EditorGUI.BeginChangeCheck();
                        ...
                        if (EditorGUI.EndChangeCheck())
                        {
                            if (text != null)
                            {
                                if (m_LineType.enumValueIndex == (int)Mod_InputField.LineType.SingleLine)
                    ...
                    if (m_ContentType.enumValueIndex == (int)Mod_InputField.ContentType.Custom)
                    {
                        ...
                        if (m_CharacterValidation.enumValueIndex == (int)Mod_InputField.CharacterValidation.Regex)
                        {
                            EditorGUILayout.PropertyField(m_RegexValue);
                        }
                        else if (m_CharacterValidation.enumValueIndex == (int)Mod_InputField.CharacterValidation.CustomValidator)
                        {
